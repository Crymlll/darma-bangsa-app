...
const BuatPerizinan = ({route, navigation}) => {
    ...
    const onChange = (event, value) => {
        ...
        setDate(value);
        setDataPerizinan({ ...dataPerizinan, tanggal: dateFormatDayMonthYear(value) });
    };
    ...
    <View style={perizinanMenuStyle.container}>
      ...
      <View style={perizinanMenuStyle.box}>
        <View style={perizinanMenuStyle.youngBlueBox}>
            <Text>Izin dispensasi hanya diterima jika mempunyai alasan dan bukti yang jelas</Text>
        </View>
        ...
        <View style={perizinanMenuStyle.package}>
            ...
            <View style={perizinanMenuStyle.formDateTime}>
                ...
                <View style={perizinanMenuStyle.pickedDateContainer}>
                    <Text onPress={showPicker} style={perizinanMenuStyle.pickedDate}>Tanggal Dipilih : {moment(date).format('D MMMM YYYY')}</Text>
                </View>
            </View>
        </View>
        ...
        <TouchableOpacity
            ...
            onPress={() => {
              console.log(data)
                ...
                navigation.navigate('DetailPerizinan', {userData : data.userData, perizinan: dataPerizinan})
            }}
        >
