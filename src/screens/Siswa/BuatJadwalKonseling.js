...
const BuatJadwalKonseling = ({ route, navigation}) => {
    ...
    const onChange = (event, value) => {
        ...
        setDate(value);
        setDataKonseling({ ...dataKonseling, tanggal: dateFormatDayMonthYear(value) });
    };
        ...
        <View style={konselingMenuStyle.package}>
            ...
            <View style={konselingMenuStyle.formSingle}>
                <TextInput
                    ...
                    onChangeText={clickHandler('permasalahan')}
                />
            </View>
        </View>
        ...
        <View style={konselingMenuStyle.package}>
            ...
            <View style={konselingMenuStyle.formDateTime}>
                ...
                <View style={konselingMenuStyle.pickedDateContainer}>
                    <Text onPress={showPicker} style={konselingMenuStyle.pickedDate}>Tanggal Dipilih : {moment(date).format('D MMMM YYYY')}</Text>
                </View>
            </View>
        </View>
        ...
        <View style={konselingMenuStyle.package}>
            ...
            <View style={konselingMenuStyle.formDateTime}>
                <Picker
                    ...
                    style={{ width: '80%', color:'#000000', marginLeft: '5%' }}
                    onValueChange={(itemValue) => setDataKonseling({...dataKonseling, jam: itemValue})}
                    >
